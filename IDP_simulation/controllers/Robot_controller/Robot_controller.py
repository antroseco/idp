...
robot.combine_two_list()
# print('robot.box_list',robot.box_list)
# print('robot.other_box_list',robot.other_box_list)
# print('combined box list:', robot.unique_list)
robot.unique_list_remove_duplicate()
# print('combined box list:', robot.unique_list)
